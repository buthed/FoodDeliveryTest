...
//    const val TAGS = "/uc?export=download&id=1BHwl51RkhdFIfquepjQS6YDD37fo3lOR"

    const val BASE_URL = "https://api.npoint.io"
    const val PRODUCTS = "/4f016585cdf2c87bfb09"
    const val CATEGORIES = "/57f1a648304ed200ded3"
    const val TAGS = "/9e4ce7be93f8bdca5681"
}